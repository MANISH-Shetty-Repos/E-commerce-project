...
<head>
    ...
    <title>Admin Login - Merchant Command Center</title>
...
<body>
    ...
    <div class="login-card animate-fade-in">
        <div class="login-header">
            ...
            <div class="login-subtitle">Merchant Command Center</div>
        </div>
        ...
        <form action="/admin/loginvalidate" method="post">
            <div class="input-group">
                ...
                <input type="text" id="username" name="username" placeholder="Enter system username" required autofocus>
            </div>
        ...
        <a href="/" class="back-link">← Return to Public Storefront</a>
    </div>
